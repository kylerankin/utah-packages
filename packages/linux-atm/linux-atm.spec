# Parity recipe (utah-packages#149): ppoatm (part of ppp) links libatm.so.1 and
# BuildRequires linux-atm-libs-devel; not in Hummingbird or the factory. Stage 0
# so ppp (stage 1) sees libatm.so.1.
...
* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.5.1-46
